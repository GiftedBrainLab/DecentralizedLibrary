...
export default function LiveDashboard() {
  ...
  return (
    <div className=" bg-gray-500 mt-24 sm:mt-14">
      <NavbarLive />
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-12 bg-gray-500 mt-14">
        ...
        <div className="md:items-center">
          <center>
            <br />
            <h2 className="text-6xl font-bold leading-1 text-black-900 sm:text-5xl hover:opacity-25">Live Streaming Dashboard</h2>
            <br />
            <br />
          </center>
        </div>

        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 mt-10 mb-20">
          {actions.map((person) => (
            <div
              key={person.name}
