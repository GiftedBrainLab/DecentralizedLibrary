...
export default function CSVideos() {
  ...
  async function watchVideo(nft) {
    ...
    // loadvideos();
    navigate("/videobooks/watching", { state: token });
  }
            ...
            {nfts.map((nft, i) => (
              ...
              <div key={i} className="border shadow rounded-xl overflow-hidden border-2 border-white-500">
                ...
                <div className="p-2">
                  ...
                  <p style={{ height: "44px" }} className="text-xl font-semibold">Creator(s):{nft.author}</p>
                  <div style={{ height: "70px", overflow: "hidden" }}>
                    <p className="text-gray-700">Description: {nft.description}</p>
                  </div>
                  <p className="text-xl font-bold text-white">{nft.pages} Time</p>
                </div>
